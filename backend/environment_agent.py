    ...
    },
    {
        ...
        "function": {
            ...
            "parameters": {
                ...
                "required": ["environment_type", "description", "thresholds", "disabled_events"],
            },
        },
    },
]

_SYSTEM_PROMPT = """You are a security camera system configuration expert. Your job is to tune detection thresholds and create custom rules for a specific deployment environment.

First call get_current_config to see the baseline, then call apply_config with your recommended settings.

Environment tuning guidelines:
...
After applying, write a 2-3 sentence plain-language explanation of what you changed and why."""
